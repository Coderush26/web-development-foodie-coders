...
- `app/overview/page.tsx`: dedicated operational summary route that keeps the home page focused on access and navigation.
...
- `docs/auth-db-phases.md`: productization roadmap for invite-based super-admin onboarding, Drizzle-backed Postgres persistence, and protected role routes.
